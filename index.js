...
const progressEl = document.querySelector(".progressBarFront");
...
function updateStepProgress() {
    stepsEl.forEach((stepEl, idx) => {
        if(idx < currentChecked){
            ...
            stepEl.innerHTML = `<i class="fa-solid fa-check" style="color: #1ea6b8;"></i><small>${idx === 0 ? "Start" : idx === stepsEl.length - 1 ? "Final" : "Step " + idx}</small>`;
